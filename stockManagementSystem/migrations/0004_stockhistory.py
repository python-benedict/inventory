...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stockManagementSystem', '0003_stock_date'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='stockManagementSystem.category')),
            ],
        ),
    ]
